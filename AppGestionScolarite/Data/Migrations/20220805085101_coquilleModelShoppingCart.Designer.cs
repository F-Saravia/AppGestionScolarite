...
namespace AppGestionScolarite.Data.Migrations
{
    ...
    [Migration("20220805085101_coquilleModelShoppingCart")]
    partial class coquilleModelShoppingCart
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppGestionScolarite.Models.Parcour", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AppGestionScolarite.Models.UnitePedagogique", b =>
                {
                    ...
                    b.ToTable("UnitePedagogique");
                });

            modelBuilder.Entity("AppGestionScolarite.Models.Utilisateur", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ModuleParcour", b =>
                {
            ...
            modelBuilder.Entity("AppGestionScolarite.Models.Session", b =>
                {
                    b.HasOne("AppGestionScolarite.Models.Parcour", "Parcour")
                        .WithMany("Sessions")
            ...
            modelBuilder.Entity("AppGestionScolarite.Models.Utilisateur", b =>
                {
                    b.HasOne("AppGestionScolarite.Models.Session", "Sessions")
            ...
            modelBuilder.Entity("ModuleParcour", b =>
                {
                    b.HasOne("AppGestionScolarite.Models.Module", null)
                        .WithMany()
                        .HasForeignKey("ModulesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AppGestionScolarite.Models.Parcour", null)
                        .WithMany()
